...
class AnimatedFlipCounterTest extends StatefulWidget {
  @override
  _AnimatedFlipCounterTestState createState() => _AnimatedFlipCounterTestState();
}

class _AnimatedFlipCounterTestState extends State<AnimatedFlipCounterTest> {
  double _value = 0.0;
