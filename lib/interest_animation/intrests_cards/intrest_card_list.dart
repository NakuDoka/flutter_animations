...
import 'intrest_card_render.dart';
import 'intrests_data.dart';
import 'rotation_3d.dart';

class IntrestCardList extends StatefulWidget {
  final List<Intrest> intrests;
  final Function onInterestChange;

  const IntrestCardList(
      {super.key, required this.intrests, required this.onInterestChange});

  @override
  IntrestCardListState createState() => IntrestCardListState();
}

class IntrestCardListState extends State<IntrestCardList>
    ...
    return Container(
      ...
      child: Rotation3d(
        ...
        child: TravelCardRenderer(
          ...
          intrest: widget.intrests[itemIndex % widget.intrests.length],
  ...
  bool _handleScrollNotifications(Notification notification) {
    ...
    if (notification is ScrollUpdateNotification) {
      ...
      widget.onInterestChange(widget.intrests
          .elementAt(_pageController.page!.round() % widget.intrests.length));
    }
    //Scroll Start
